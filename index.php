...
<html lang="en">
    ...
    <head>
        ...
        <title>Googlock Holmes 2018</title>
...
<div class="col-md-4 center"></div>
            ...
            <div class="col-md-4 right"><a href="https://www.facebook.com/synapsedaiict/" target="_blank"><img src="assets/img/synapse.png" alt="synapse Logo" width="20%" style="padding:10px 0px 0px 0px"></a></div>
         </div>


         <div style="color:white" class="col-md-offset-3 col-md-6">
                        <h1 style="color:white" ><strong>Googlock Holmes 2018</strong></h1>
        ...
        <div class="panel-body">
                                <form id="loginform" method="post" action="log.php" class="login-form">
                                    <div class="form-group">
                                        ...
                                        <input style="border:1px solid grey" type="email" name="getemail" placeholder="Email..." class="form-username form-control" id="form-username" required >
                                    </div>
                                    <div class="form-group">
      ...
      <div id="collapse3" class="panel-collapse collapse in">
        <div class="panel-body">
            <ul style="color:black">
                ...
                <li>You will have 15 questions and 1 hour time to answer them. Each correct answer gives you 5 marks. There is no negative marking for wrong answers.</li>
                <li>You have an option to skip a question. However, you can't traverse back i.e. any question can't be visited again.</li>
                <li>The submitted answer should be to the point and in lowercase with spaces wherever required. So if the answer is "Sudoku Nightmare", you need to submit "sudoku nightmare" for it to be accepted.</li>
            </ul>
                    ...
                    <br>
                                ...
                                <div class="btn azm-social azm-size-48 azm-r-square azm-android">
                                        ...
                                        <a class="tn btn-primary btn-lg" target="_blank" href="https://www.facebook.com/synapsedaiict/">
